...
🤖 Giving AI tools (Copilot / Cursor) better project context
...
```
my-app/
├── client/   → React Frontend (Vite + Context API)
└── server/   → Node + Express Backend (JWT + MongoDB)
```
...
**Security:** bcrypt, OTP, Rate Limiting
...
MIT © 2025 [Sameer Bagul](mailto:sameerbagul2004@gmail.com)
